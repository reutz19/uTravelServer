...
public class FlightTrafficSearchResponse   {
  
  private String period = null;
  private String origin = null;
  private List<FlightTrafficSearchResult> results = new ArrayList<FlightTrafficSearchResult>();
  ...
  public List<FlightTrafficSearchResult> getResults() {
    return results;
  }
  public void setResults(List<FlightTrafficSearchResult> results) {
